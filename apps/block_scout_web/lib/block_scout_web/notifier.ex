defmodule BlockScoutWeb.Notifier do
  ...
  # internal transactions broadcast disabled on the indexer level, therefore it out of scope of the refactoring within https://github.com/PrivixAI-labs/blockscout/pull/7474
