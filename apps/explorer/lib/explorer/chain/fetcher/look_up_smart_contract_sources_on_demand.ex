defmodule Explorer.Chain.Fetcher.LookUpSmartContractSourcesOnDemand do
  @moduledoc """
    On demand fetcher sources for unverified smart contract from [Ethereum Bytecode DB](https://github.com/PrivixAI-labs/blockscout-rs/tree/main/eth-bytecode-db/eth-bytecode-db)
  """
