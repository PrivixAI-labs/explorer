...
export MIX_ENV=prod
export DATABASE_URL=postgresql://nlg:nlg@localhost:5432/blockscout-testnet
...
export PORT=3000
export BLOCKSCOUT_HOST=testnet.privixscan.io
export BLOCKSCOUT_PROTOCOL=https
mix phx.server
